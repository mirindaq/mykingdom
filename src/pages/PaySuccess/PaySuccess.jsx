    ...
    <div>
        <div className='pt-40 pb-30'>
            ...
            <div className='flex justify-center mt-18'>
                <Link to={path.homepage}><button className='bg-red-600 text-2xl text-white font-medium px-18 py-4 rounded-2xl hover:cursor-pointer'>Quay về trang chủ</button></Link>
            </div>
        </div>
    </div>
  )
