    ...
    return (
      <div className="bg-amber-50 py-10">
        <div className="flex items-center justify-center">
          <p className="mt-10 mb-10 ml-4 text-4xl font-bold">
        ...
        <div>
          ...
          <div className="flex justify-center items-center pb-10">
            <button className="rounded-xl bg-red-600 py-3 px-20 text-base font-bold text-white hover:cursor-pointer">Tiếp tục mua sắm</button>
          </div>
        </div>
      </div>
    );
